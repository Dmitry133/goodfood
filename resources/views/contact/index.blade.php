                            ...
                            <form action="{{ route('contact.send') }}" method="post" id="contact_form" class="contact_form">
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        ...
                                        <input type="text" name="name" id="name" class="contact_input" required="required">
                                    </div>
                                </div>
                                <div>
                                    <!-- Subject -->
                                ...
                                <div>
                                    ...
                                    <textarea name="message" id="message" class="contact_input contact_textarea" required="required"></textarea>
                                </div>
                ...
                <div class="col-lg-3 offset-xl-1 contact_col">
                    <div class="contact_info">
                        <div class="contact_info_section">
                            ...
                            <ul>
                                <li>Phone: <span>+0-000-000-00-00</span></li>
                                <li>Email: <span>goodfood@gmail.com</span></li>
                            </ul>
                        </div>
                        <div class="contact_info_section">
